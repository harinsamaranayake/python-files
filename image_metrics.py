...
def read_from_folder(path_true=None, path_pred=None):
    ...
    for img in pred_list:
        ...
        pred_img = cv2.resize(pred_img, (640, 352))
        true_img = cv2.resize(true_img, (640, 352))
    ...
    print('true_new_img', true_list_new.shape)
    print('pred_new_img', pred_list_new.shape)
...
def scikit_metrix(true_list_new=None, pred_list_new=None):
    ...
    print("Precision\t: ", precision_score(
        y_true=y_true, y_pred=y_pred, pos_label=255))
    # print("Precision : ", precision_score(y_true=y_true, y_pred=y_pred,average='weighted'))

    print("Recall\t\t: ", recall_score(
        y_true=y_true, y_pred=y_pred, pos_label=255))
    print("F1_Score\t: ", f1_score(y_true=y_true,
                                   y_pred=y_pred, pos_label=255), '\n')
...
if __name__ == '__main__':
    # path_true = '/Users/harinsamaranayake/Documents/Research/Datasets/FCN8s/original/mask/on_road'
    # path_pred = '/Users/harinsamaranayake/Documents/Research/Datasets/FCN8s/original/color/on_road'

    path_true = '/Users/harinsamaranayake/Desktop/RESEARCH NEW/dof/gt'
    path_pred = '/Users/harinsamaranayake/Desktop/RESEARCH NEW/dof/pred'

    true_list_new, pred_list_new = read_from_folder(
        path_true=path_true, path_pred=path_pred)
    confusion_metrics_method_01(
        true_list_new=true_list_new, pred_list_new=pred_list_new)
