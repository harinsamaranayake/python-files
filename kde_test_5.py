# https://plot.ly/python/v3/ipython-notebooks/2d-kernel-density-distributions/
# https://stackoverflow.com/questions/58073760/how-to-import-plotly-on-google-colab
...
d=4
N=100
# print(virginica.SepalLength)
# print(virginica.SepalWidth)
fig=make_kdeplot(virginica.SepalLength, virginica.SepalWidth, a,b, c,d,N, cubehelix_cs, 'kde plot of joint distribution for virginica SepalLength and SepalWidth')
